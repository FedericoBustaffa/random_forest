...
single node multi-processing parallelization. Below are reported runtime results
on Magic dataset

\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/magic_runtime.svg}
  \caption{Magic dataset training and prediction runtime varying the number of workers}
  \label{fig: magic_runtime_worker}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/susy20k_runtime.svg}
  \caption{SUSY dataset training and prediction runtime varying the number of workers}
  \label{fig: susy_runtime_worker}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Magic dataset training and prediction speedup varying the number of workers}
...
\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/susy20k_speedup.svg}
  \caption{SUSY dataset training and prediction speedup varying the number of workers}
...
\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/susy20k_efficiency.svg}
  \caption{SUSY dataset training and prediction efficiency varying the number of workers}
...
\begin{figure}[H]
  ...
  \caption{Magic dataset training and prediction efficiency varying the number of workers}
