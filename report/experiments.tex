...
\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/shared_training_speedup.svg}
  \caption{Training speedup on Magic and SUSY datasets}
...
\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/shared_training_speedup.svg}
  \caption{Prediction speedup on Magic and SUSY datasets}
  \label{fig: prediction_speedup}
\end{figure}
...
consider only 16 and 32 threads per node, leaving the number of trees fixed to
256 for most of the metrics.


\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/distributed_training_time.svg}
  \caption{Training time on SUSY datasets}
  \label{fig: distributed_training_time}
\end{figure}


\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/distributed_prediction_time.svg}
  \caption{Prediction time on SUSY datasets}
  \label{fig: distributed_prediction_time}
\end{figure}


\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/distributed_training_speedup.svg}
  \caption{Training speedup on SUSY datasets}
...
\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/distributed_prediction_speedup.svg}
  \caption{Prediction speedup on SUSY datasets}
  \label{fig: distributed_prediction_speedup}
\end{figure}


\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/distributed_training_efficiency.svg}
  \caption{Training efficiency on SUSY datasets}
  \label{fig: distributed_training_efficiency}
\end{figure}

\begin{figure}[H]
  \centering
  \includesvg[width=\linewidth]{images/distributed_prediction_efficiency.svg}
  \caption{Prediction efficiency on SUSY datasets}
  \label{fig: distributed_prediction_efficiency}
\end{figure}
